...
const solutions = [
  {
    ...
    description: "Ultra-fast, SEO-optimized landing pages and corporate websites using Next.js and Tailwind CSS.",
    bullets: ["Search Performance Optimization", "Custom CMS Integration", "Web Vitalization"],
  },
  {
    icon: Bot,
    title: "AI Systems & Automation",
    description: "Leverage the power of Generative AI. We build custom RAG pipelines, chatbots, and automation agents.",
    bullets: ["Custom GPT Integrations", "LangChain/LlamaIndex Solutions", "Workflow Automation"],
  },
  {
    icon: Server,
    title: "Scalable SaaS Development",
    description: "From MVP to enterprise-grade platforms. We handle authentication, payments, and multi-tenant databases.",
    bullets: ["Multi-Tenant Architecture", "Subscription Management", "Secure Infrastructure"],
  },
  {
    icon: Workflow,
    title: "Business Process Automation",
    description: "Optimize your operations by automating repetitive tasks. Custom CRMs, dashboards, and data pipelines.",
